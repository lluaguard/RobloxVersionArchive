...
pub fn get_archive_url(
    ...
    format!(
        "https://raw.githubusercontent.com/lluaguard/RobloxVersionArchive/main/{}/{}/{}/{}",
...
mod tests {
    ...
    fn archive_url_formatted_correctly() {
        ...
        assert_eq!(archive_url, "https://raw.githubusercontent.com/lluaguard/RobloxVersionArchive/main/Global/WindowsPlayer/LIVE/DeployHistory.json");
    }
}
